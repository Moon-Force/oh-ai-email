...
| ID    | 任务                          | 说明                                                                                          | 状态 |
| ----- | ----------------------------- | --------------------------------------------------------------------------------------------- | ---- |
| W3-01 | 学用户语气                    | 从已发送采样（优先本机）；提取专属画像，支持「以我的风格」草拟/改写                           | [x]  |
| W3-02 | 承诺追踪                      | 「周五给你」→ 本地提醒，不自动发跟进                                                          | [x]  |
| W3-03 | 附件理解                      | 附件要点提炼与智能概览；默认关，显式点击芯片「✦ AI 提取」                                     | [x]  |
...
| W3-08 | 联系人卡片                    | 最近话题 / 未结事项（灵感池）                                                                 | [-]  |
| W3-09 | 流式输出                      | Capsule/Composer/Attachment 打字机平滑流式渲染                                                | [x]  |
